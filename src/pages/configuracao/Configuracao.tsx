...
export const Configuracao = () => {
    ...
    return (
        <section id="configuracao" className="w-full max-h-[calc(100vh-92px)] lg:max-h-screen flex flex-col lg:justify-between lg:p-12 overflow-auto">
            <div className="flex flex-col">
                <div className="lg:ml-4 flex flex-col gap-10 mt-4 px-4">
                    ...
                    <div className="max-w-[100%] text-justify lg:text-left">
                ...
                <div className="lg:ml-4 lg:mt-10 flex flex-col gap-3 px-4 mt-4">
