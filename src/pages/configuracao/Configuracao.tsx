...
export const Configuracao = () => {
    ...
    const [descricao, setDescricao] =
        useState<string>(`Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe modi quis maiores molestiae doloribus esse tenetur amet optio praesentium rem, expedita atque quia ratione quasi sunt assumenda accusantium sequi nihil.
    ...
    return (
        <section
            id="configuracao"
            className="w-full max-h-[calc(100vh-92px)] lg:max-h-screen flex flex-col lg:justify-between md:justify-between lg:p-12 overflow-auto md:h-screen md:px-2 "
        >
                    ...
                    <div className="flex md:flex-col lg:flex-row items-center gap-8">
                        ...
                        <div>
                            <h1 className="text-xl lg:text-3xl font-semibold">
                                R9ação - Soluções Integradas
                            </h1>
                        </div>
                    </div>
                    <div className="max-w-[100%] flex flex-col lg:flex-row text-justify lg:text-left md:font-semibold xl:font-semibold font-medium text-sm px-2">
            ...
            <div className="p-5 mr-3 md:mb-8 xl:mb-0 flex justify-between lg:justify-end xl:justify-end xl:pt-8 md:py-6">
                ...
                <Button
                    className="md:h-12 md:w-32 md:text-xl xl:h-9 xl:w-32 xl:text-lg"
                    children="Editar"
                    variant="solid"
                    type="button"
