...
export const RecuperacaoDeSenhaP3 = () => {
    return (
        <div className="bg-[#F9FAFB] min-h-screen flex flex-col px-4 sm:px-0">
            ...
            <div className="bg-white border-[2px] border-[#3C68C5] shadow-[4px_4px_10px_rgba(0,0,0,0.25)] rounded-3xl p-6 sm:p-8  w-full max-w-[355px] aspect-[521/609] mx-auto text-center">
