...
export const RecuperacaoDeSenhaP1 = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center' >
            ...
            <div className="flex flex-col justify-center items-center bg-white border-[2px] border-[#3C68C5] shadow-[4px_4px_10px_rgba(0,0,0,0.25)] rounded-3xl p-6 w-[340px] sm:w-[340px] md:w-[450px] h-[430px] sm:h-[540px] xl:mt-auto mt-14 sm:mt-3 md:mt-28 lg:mt-3 sm:mb-5 lg:mb-9 aspect-[521/609] mx-auto text-center">
                ...
                <div className="mb-20 text-left">
                    <label className="block text-gray-950 text-base sm:text-lg md:text-xl font-bold mb-1" htmlFor="email">
                        E-mail
                    </label>
                    <input
                        type="email"
