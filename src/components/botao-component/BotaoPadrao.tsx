...
export const BotaoPadrao = (props: BotaoPadraoProps) => {
    return (
        <button
            className={clsx("fixed z-20 lg:relative lg:bottom-0 lg:right-0 bottom-20 right-2 rounded-full px-2 bg-colorMenuPrimary lg:rounded-xl flex text-white lg:px-4 py-2 lg:gap-4 justify-between items-center")}
