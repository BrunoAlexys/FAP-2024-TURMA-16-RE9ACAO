    ...
    return (
        <div className="w-full flex flex-col gap-2">
            ...
            {type === "UF" ? (
                <select
                    className={twMerge(
                        'border-b lg:border-2 border-colorMenuSecondary lg:rounded-full px-4 py-2 w-full focus:outline-none lg:focus:border-2 focus:border-colorMenuPrimary appearance-none relative custom-select',
                ...
                <InputMask
                    ...
                    type={type}
                    className={twMerge(
                        'border-b lg:border-2 border-colorMenuSecondary lg:rounded-full px-4 py-2 w-full focus:outline-none lg:focus:border-2',
